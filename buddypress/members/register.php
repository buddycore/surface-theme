											...
											<div<?php bp_field_css_class('editfield'); ?>>
												...
												<?php else : ?>
													...
													<p class="field-visibility-settings-notoggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
														<?php printf(__('This field can be seen by: %s', 'buddypress'), '<span class="current-visibility-leve">' . bp_get_the_profile_field_visibility_level_label() . '</span>'); ?>
													</p>
					...
					<div id="blog-details"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>
						...
						<div class="row">
							<div class="column one-half">
								<div class="editfield">
									...
									<?php else : ?>
									<input placeholder="<?php echo home_url( '/' ); ?>" type="text" name="signup_blog_url" id="signup_blog_url" value="<?php bp_signup_blog_url_value(); ?>" />
									<?php endif; ?>
						...
						<div class="row">
							<div class="column">
								...
								<fieldset>
									<legend><?php _e( 'I would like my site to appear in search engines, and in public listings around this network.', 'buddypress' ); ?></legend>
